...
export const Starch: Recipe[] = [
	...
	{
		id: 29,
		name: 'Herb-Roasted Baby Potatoes',
		servings: '4',
		ingredients: [
	...
	},
	{
		...
		instructions: [
			'Bring water or broth to a boil, slowly whisk in polenta.',
	...
	{
		id: 33,
		name: 'Saffron Risotto with Parmesan',
		servings: '4',
		ingredients: [
			'1 cup Arborio rice',
		...
		instructions: [
			'Melt butter in a pan, sauté onion until translucent.',
	...
	{
		id: 35,
		name: 'Parmesan Roasted Fingerling Potatoes',
		servings: '4',
		ingredients: [
	...
	},
	{
		...
		instructions: [
			...
			'Sauté onion and mushrooms in butter, then fold in cooked rice.',
			'Season with salt and pepper and serve warm.'
		],
	...
	{
		id: 37,
		name: 'Crispy Parmesan Polenta Fries',
		servings: '4',
		ingredients: [
			'1 cup polenta (cornmeal)',
			'4 cups water',
		...
		instructions: [
			'Cook polenta in water until thickened.',
			'Spread in a baking dish, cool and cut into sticks.',
			'Toss with olive oil, bake at 425°F (220°C) 20 minutes until crispy, sprinkle with Parmesan and season.'
		],
	...
	{
		id: 38,
		name: 'Cheesy Crispy Garlic Smashed Potatoes',
		servings: '4',
		ingredients: [
		...
		instructions: [
			...
			'Smash potatoes gently, drizzle with olive oil, garlic, and rosemary.',
			'Roast at 450°F (230°C) 15 minutes.',
			'Add cheese cook for 5 min or until golden to choice'
		],
	...
	{
		id: 39,
		name: 'Gourmet Sweet Potato Mash with Sage',
		servings: '4',
		ingredients: [
	...
	{
		id: 40,
		name: 'Brown Butter Gnocchi with Parmesan',
		servings: '4',
		ingredients: [
			'1 lb potato gnocchi',
