...
export const Pancakes: Recipe[] = [
	{
		...
		instructions: [
			...
			'Cook ¼ cup batter per pancake on a greased skillet over medium heat until golden on both sides.',
	...
	},
	{
		...
		instructions: [
			...
			'Add milk, eggs, and butter; stir until just combined.',
			'Fold in blueberries gently.',
			'Cook on greased skillet until bubbles form and edges are set; flip and cook until golden.',
	...
	},
	{
		...
		instructions: [
			...
			'Add milk, egg, and butter; mix until combined.',
			'Fold in chocolate chips.',
			'Cook on medium heat until golden brown and melty.',
			'Top with whipped cream or chocolate drizzle.'
		],
		tags: [
			'sweet',
			'chocolate',
	...
	},
	{
		...
		instructions: [
			...
			'Mix milk, egg, banana, and butter in another bowl.',
			'Combine and stir until smooth.',
			'Cook pancakes until golden; serve with sliced banana and honey.'
		],
	...
	},
	{
		...
		instructions: [
			...
			'Mix ricotta, milk, eggs, lemon zest, and juice in another bowl.',
			'Combine and stir until smooth.',
			'Cook over medium heat until golden and fluffy.',
	...
	},
	{
		...
		instructions: [
			...
			'Cook ¼ cup batter per pancake until golden.',
	...
	},
	{
		...
		instructions: [
			...
			'Mix milk, pumpkin, egg, and butter separately.',
			'Combine and stir until smooth.',
	...
	},
	{
		...
		instructions: [
			...
			'Cook pancakes on nonstick skillet until golden.',
			'Serve with peanut butter or berries.'
		],
	...
	},
	{
		...
		instructions: [
			'Prepare batter and mix cinnamon swirl (brown sugar + butter).',
			'Cook pancake and swirl mixture on top in a spiral.',
	...
	},
	{
		...
		instructions: [
			...
			'Mix wet ingredients and grated apple separately.',
			'Combine both and stir.',
			'Cook pancakes until golden.',
			'Serve with warm apple compote or syrup.'
		],
		tags: [
			'apple',
			'cinnamon',
	...
	},
	{
		...
		instructions: [
			'Mix dry ingredients.',
			'Whisk milk, egg, and oil together.',
			'Combine and cook until golden brown.',
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients.',
			'Whisk in coconut milk, egg, and oil.',
	...
	},
	{
		...
		instructions: [
			...
			'Cook on medium-low heat until set and golden.',
	...
	},
	{
		...
		instructions: [
			'Prepare batter and fold in half the strawberries.',
			'Cook pancakes until golden.',
			'Layer with whipped cream and more strawberries.'
		],
		tags: [
			'strawberry',
			'dessert',
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients in a bowl.',
			'Whisk milk, eggs, and butter; add herbs and pepper.',
			'Cook until golden brown.',
			'Serve with smoked salmon or sour cream.'
		],
	...
	},
	{
		...
		instructions: [
			...
			'In another bowl, mix milk, egg yolks, butter, and vanilla.',
			'Beat egg whites until stiff peaks form and fold into batter.',
			'Cook until golden and crisp. Serve with syrup or berries.'
		],
		tags: [
			'classic',
			'crisp',
	...
	},
	{
		...
		instructions: [
			...
			'Add flour, eggs, butter, and vanilla; knead until smooth.',
			'Let rise for 1 hour, then fold in pearl sugar.',
			'Cook in waffle iron until golden and caramelized.'
		],
	...
	{
		id: 18,
		name: 'Cheddar Chive Savory Waffles',
		servings: '4',
		ingredients: [
			'2 cups flour',
			'2 tsp baking powder',
		...
		instructions: [
			...
			'Add milk, eggs, and butter; stir until smooth.',
			'Fold in cheese and chives.',
			'Cook until golden and serve with sour cream or bacon.'
		],
	...
	},
	{
		...
		instructions: [
			...
			'Whisk wet ingredients together, then combine.',
			'Cook until crisp; top with cream cheese glaze.'
		],
		tags: [
			'red-velvet',
			'sweet',
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients.',
			'Whisk milk, eggs, and butter separately, then combine.',
			'Cook until golden and crisp; serve with honey butter or chili.'
		],
		tags: [
			'cornmeal',
			'southern',
	...
	},
	{
		...
		instructions: [
			...
			'Add wet ingredients and mix until smooth.',
			'Cook until crisp; serve with whipped cream or ice cream.'
		],
	...
	},
	{
		...
		instructions: [
			'Mix dry ingredients.',
			'Blend wet ingredients together, then combine.',
			'Cook until crisp; serve with maple butter.'
		],
		tags: [
			'sweet-potato',
			'autumn',
	...
	},
	{
		...
		instructions: [
			...
			'Fold in bacon bits and cook until crisp.',
			'Serve with maple syrup or fried egg.'
		],
		tags: [
			'bacon',
			'savory',
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients.',
			'Whisk wet ingredients and mix together.',
			'Cook until golden; serve with tropical fruit and whipped cream.'
		],
		tags: [
			'tropical',
			'coconut',
	...
	},
	{
		...
		instructions: [
			'Squeeze moisture from grated potatoes.',
			'Mix all ingredients in a bowl.',
			'Cook in waffle iron until crisp and golden.',
			'Serve with sour cream or smoked salmon.'
		],
		tags: [
			'savory',
			'potato',
	...
	},
	{
		...
		instructions: [
			...
			'Cook until crisp and aromatic.',
			'Serve with chocolate syrup or mascarpone cream.'
		],
		tags: [
			'coffee',
			'chocolate',
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients.',
			'Whisk wet ingredients and mix into a smooth batter.',
			'Cook until crisp and lightly green.',
			'Serve with whipped cream or red bean paste.'
		],
	...
	{
		id: 28,
		name: 'Gluten-Free Buckwheat Waffles',
		servings: '4',
		ingredients: [
		...
		instructions: [
			'Whisk dry ingredients.',
			'Add milk, eggs, and oil; stir until combined.',
			'Cook until crisp and nutty.',
			'Serve with honey or fruit compote.'
		],
		tags: [
			'gluten-free',
			'buckwheat',
	...
	},
	{
		...
		instructions: [
			'Whisk dry ingredients and stir in carrots.',
			'Add milk, eggs, and butter; mix until combined.',
			'Cook until crisp; serve with cream cheese glaze.'
		],
	...
	{
		id: 30,
		name: 'Yeasted Overnight Waffles',
		servings: '6',
		ingredients: [
			'2 cups flour',
			'1 tbsp sugar',
		...
		instructions: [
			'Combine milk, sugar, and yeast; let sit for 5 minutes.',
			'Add flour and salt; mix well, then rest overnight in fridge.',
			'In the morning, whisk in eggs and butter.',
	...
	},
	{
		...
		instructions: [
			...
			'Pour in a thin layer of batter and tilt to coat the pan.',
			'Cook for 1 minute per side until golden.',
			'Serve warm with lemon and sugar or jam.'
		],
		tags: [
			'sweet',
			'french',
	...
	},
	{
		...
		servings: '2',
		ingredients: ['4 crepes', '4 tbsp Nutella', '1 banana, sliced', 'Whipped cream for topping'],
		instructions: [
			'Spread 1 tbsp Nutella on each warm crepe.',
			'Add banana slices and fold into quarters.',
	...
	},
	{
		...
		instructions: [
			...
			'Fill crepes with spinach and feta, then roll up.',
	...
	},
	{
		...
		instructions: [
			'Fill crepes with strawberries and whipped cream.',
	...
	{
		id: 35,
		name: 'Savory Ham and Cheese Crepes',
		servings: '2',
		ingredients: [
			'4 crepes',
			'4 slices ham',
		...
		instructions: [
			'Spread Dijon mustard on each crepe.',
			'Add ham and cheese, fold, and heat until melted.',
			'Serve hot.'
		],
	...
	},
	{
		...
		instructions: [
			'Mix blueberries with lemon zest and lemon curd.',
	...
	},
	{
		...
		instructions: [
			...
			'Season with salt and pepper.',
			'Fill crepes with mushrooms and cheese.',
			'Heat until cheese melts and serve warm.'
		],
	...
	{
		id: 38,
		name: 'Peaches and Cream Crepes',
		servings: '4',
		ingredients: ['4 crepes', '1 cup peaches, sliced', '½ cup whipped cream', '1 tbsp honey'],
		instructions: [
			'Fill crepes with peaches and cream.',
			'Drizzle with honey and fold gently.',
	...
	{
		id: 39,
		name: 'Smoked Salmon and Dill Crepes',
		servings: '2',
		ingredients: [
			'4 crepes',
			'4 oz smoked salmon',
		...
		instructions: [
			'Spread cream cheese on crepes.',
			'Top with salmon and dill.',
			'Sprinkle lemon juice and roll up to serve.'
		],
	...
	},
	{
		...
		instructions: [
			'Sauté apples with butter, cinnamon, and sugar until soft.',
	...
	},
	{
		...
		instructions: [
			'Mix chicken, spinach, and ricotta.',
			'Season and fill crepes.',
			'Roll and bake at 350°F for 10 minutes until heated through.'
		],
		tags: [
			'savory',
			'chicken',
	...
	{
		id: 42,
		name: 'Chocolate Hazelnut Crepes',
		servings: '4',
		ingredients: [
			'4 crepes',
		...
		instructions: [
			'Spread chocolate hazelnut spread on crepes.',
			'Sprinkle with chopped hazelnuts.',
			'Fold and dust with powdered sugar.'
		],
	...
	{
		id: 43,
		name: 'Ricotta and Berry Crepes',
		servings: '4',
		ingredients: ['4 crepes', '½ cup ricotta cheese', '1 cup mixed berries', '1 tbsp honey'],
		instructions: [
			'Spread ricotta on crepes.',
			'Top with berries and drizzle with honey.',
			'Fold and serve chilled.'
		],
	...
	},
	{
		...
		instructions: [
			'Sauté pears in butter and sugar until golden.',
			'Add cinnamon and cook 2 minutes more.',
	...
	{
		id: 45,
		name: 'Savory Breakfast Crepes with Eggs and Bacon',
		servings: '2',
		ingredients: [
			'4 crepes',
			'2 eggs, scrambled',
		...
		instructions: [
			'Fill crepes with scrambled eggs, bacon, and cheese.',
			'Fold and serve warm with salsa or hot sauce.'
		],
	...
	},
	{
		...
		instructions: [
			...
			'Cut in butter until crumbly, then stir in buttermilk until dough forms.',
			'Pat out, cut biscuits, and bake for 12–15 minutes until golden.'
		],
	...
	{
		id: 47,
		name: 'Biscuits with Sausage Gravy',
		servings: '4',
		ingredients: [
			'4 biscuits, baked',
		...
		instructions: [
			...
			'Season and pour over hot biscuits.'
		],
	...
	},
	{
		...
		instructions: [
			'Combine dry ingredients, cut in butter, then add cheese and chives.',
	...
	},
	{
		...
		servings: '6',
		ingredients: ['6 biscuits, baked', '3 tbsp butter, melted', '1 tbsp honey'],
	...
	},
	{
		...
		instructions: [
			'Layer egg, cheese, and bacon on biscuit halves.',
			'Serve warm as a breakfast sandwich.'
		],
	...
	{
		id: 51,
		name: 'Strawberry Jam Biscuits',
		servings: '4',
		ingredients: ['4 biscuits, baked', '4 tbsp strawberry jam'],
	...
	{
		id: 52,
		name: 'Country Ham Biscuits',
		servings: '4',
		ingredients: ['4 biscuits, baked', '4 oz country ham slices', '1 tsp mustard (optional)'],
		instructions: [
			'Warm ham in a skillet.',
			'Split biscuits, add ham, and spread mustard if desired.',
			'Serve hot.'
		],
	...
	{
		id: 53,
		name: 'Blueberry Biscuits with Lemon Glaze',
		servings: '6',
		ingredients: [
			'2 cups flour',
			'1 tbsp baking powder',
		...
		instructions: [
			'Mix dry ingredients, cut in butter, add milk and blueberries.',
			'Bake at 425°F (220°C) for 15 minutes.',
			'Whisk lemon juice with sugar and drizzle over biscuits.'
		],
	...
	{
		id: 54,
		name: 'Sausage and Cheese Stuffed Biscuits',
		servings: '6',
		ingredients: ['1 can biscuit dough', '½ lb sausage, cooked', '½ cup shredded cheddar cheese'],
		instructions: [
			'Flatten biscuits, fill with sausage and cheese.',
			'Seal and bake at 375°F (190°C) for 12–15 minutes.'
		],
	...
	{
		id: 55,
		name: 'Maple Butter Biscuits',
		servings: '6',
		ingredients: ['6 biscuits, baked', '3 tbsp butter, softened', '1 tbsp maple syrup'],
		instructions: [
			'Mix butter and maple syrup until smooth.',
			'Spread on warm biscuits and serve.'
		],
	...
	},
	{
		...
		instructions: [
			'Combine honey and hot sauce.',
			'Layer chicken in biscuits and drizzle with sauce.'
		],
	...
	{
		id: 57,
		name: 'Biscuits with Chocolate Gravy',
		servings: '4',
		ingredients: [
			'4 biscuits, baked',
			'2 tbsp butter',
		...
		instructions: [
			'Melt butter in a pan and whisk in flour and cocoa.',
			'Add sugar and milk, whisk until thick.',
	...
	{
		id: 58,
		name: 'Pimento Cheese Biscuits',
		servings: '6',
		ingredients: ['6 biscuits, baked', '½ cup pimento cheese spread'],
	...
	{
		id: 59,
		name: 'Apple Butter Biscuits',
		servings: '4',
		ingredients: ['4 biscuits, baked', '4 tbsp apple butter'],
	...
	{
		id: 60,
		name: 'Biscuits and Gravy with Bacon',
		servings: '4',
		ingredients: [
			'4 biscuits, baked',
		...
		instructions: [
			'Cook bacon until crisp, remove and leave drippings.',
			'Add flour, whisk, then add milk and stir until thick.',
			'Add bacon back and serve over biscuits.'
		],
	...
	},
	{
		...
		instructions: [
			'Mix dry ingredients, cut in butter and cheese.',
			'Add milk, form biscuits, and bake at 425°F for 15 minutes.'
		],
	...
	{
		id: 62,
		name: 'Biscuits with Country Sausage Patty',
		servings: '4',
		ingredients: ['4 biscuits, baked', '4 sausage patties', '1 slice cheddar (optional)'],
		instructions: [
			'Layer sausage and cheese in biscuit halves.',
			'Serve warm as a handheld breakfast.'
		],
	...
	},
	{
		...
		servings: '6',
		ingredients: ['6 biscuits, baked', '2 tbsp butter, melted', '2 tbsp sugar', '1 tsp cinnamon'],
	...
	{
		id: 64,
		name: 'Herbed Cream Cheese Biscuits',
		servings: '6',
		ingredients: [
			'6 biscuits, baked',
			'½ cup cream cheese',
			'1 tbsp fresh herbs (parsley, dill, chives), chopped'
		],
	...
	{
		id: 65,
		name: 'Biscuits with Country Gravy and Fried Egg',
		servings: '2',
		ingredients: ['2 biscuits, baked', '½ cup sausage gravy', '2 fried eggs'],
		instructions: [
			'Top biscuits with sausage gravy and a fried egg on each.',
			'Serve immediately.'
		],
